...
function LoginForm() {
        ...
        const checkAndRedirect = async () => {
          try {
            ...
            if (slug) {
              ...
              console.warn("Transfer failed or no slug returned, redirecting to course page to retry");
  ...
  return (
    <div className="min-h-screen bg-[#fbf9f7] flex flex-col items-center justify-center p-4 relative">
      <div className="absolute inset-0 bg-linear-gradient-to-br from-[#fbf9f7] via-white to-[#fbf9f7]"></div>
