...
function FlashcardsBlock({ flashcards, courseId }: { flashcards: NonNullable<Flashcards>; courseId?: string }) {
  ...
  return (
    <div className="rounded-2xl border border-gray-300 bg-white p-6 shadow-sm min-h-100 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center relative perspective-1000">
        ...
        {/* Main Card */}
        <div 
          className="relative w-full h-full min-h-70 cursor-pointer group perspective-1000"
