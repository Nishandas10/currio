  ...
  return (
    <ClientLayout>
      <div className="h-full flex flex-col overflow-hidden">
        {/* Fixed Header */}
        <div className="shrink-0 p-4 md:p-8 bg-white">
          <div className="max-w-7xl mx-auto">
            <div className="mb-6 flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <div className="space-y-4 flex-1 md:max-w-md text-center md:text-right">
                <h1 className="text-3xl font-bold text-gray-900">Explore courses created by the community</h1>
        ...
        <div className="flex-1 overflow-auto">
          <div className="p-4 md:p-8 pt-0 max-w-7xl mx-auto">
            {loading ? (
